...
@pytest.fixture
def bb_tracker_jobs(imghost, tmp_path, tracker, mocker):
...
@pytest.mark.parametrize(
    ...
    argvalues=(
        (False, False, {'only_title': True}, ()),
        (True, False, {'only_title': True}, ('imdb_job', 'movie_title_job')),
        (True, False, {'only_description': True}, ('imdb_job', 'movie_description_job')),
        (True, False, {'only_poster': True}, ('imdb_job', 'movie_poster_job')),
        (True, False, {'only_release_info': True}, ('movie_release_info_job',)),
        (True, False, {'only_tags': True}, ('imdb_job', 'movie_tags_job')),
        (True, False, {}, ()),
        (False, True, {'only_title': True}, ('tvmaze_job', 'series_title_job')),
        (False, True, {'only_description': True}, ('tvmaze_job', 'mediainfo_job', 'screenshots_job',
                                                   'upload_screenshots_job', 'series_description_job')),
        (False, True, {'only_poster': True}, ('tvmaze_job', 'series_poster_job')),
        (False, True, {'only_release_info': True}, ('tvmaze_job', 'series_title_job')),
        (False, True, {'only_tags': True}, ('tvmaze_job', 'series_tags_job')),
        (False, True, {}, ()),
    ),
)
...
def test_release_info_theatrical_cut(editions, exp_text, bb_tracker_jobs, mocker, tmp_path):
    mocker.patch.object(type(bb_tracker_jobs.release_name), 'edition', PropertyMock(return_value=editions))
    assert bb_tracker_jobs.release_info_theatrical_cut == exp_text
...
async def test_get_series_title_and_release_info_has_release_info(bb_tracker_jobs, mocker):
    ...
    mocker.patch.object(type(bb_tracker_jobs), 'release_info_theatrical_cut', PropertyMock(return_value='Theatrical Cut'))
...
def test_get_movie_release_info(bb_tracker_jobs, mocker):
    infos = {
        ...
        'release_info_theatrical_cut': 'Theatrical Cut',
...
async def test_get_tags_from_options(bb_tracker_jobs, mocker):
    ...
    mocker.patch.object(type(bb_tracker_jobs), 'options', PropertyMock(return_value={'tags': 'a,b,c'}))
    tags = await bb_tracker_jobs.get_tags()
    assert tags == 'normalized,tags'
    assert bb_tracker_jobs.try_webdbs.call_args_list == []
    assert bb_tracker_jobs.normalize_tags.call_args_list == [call(['a', 'b', 'c'])]
...
@pytest.mark.parametrize(
    ...
    argvalues=(
        (('comedy', 'hörrór', 'sci-fi'), 'comedy,horror,science.fiction'),
        (('Jim J. Jackson', "D'Artagnan \"The Cat\" Musketeer"), 'jim.j.jackson,dartagnan.the.cat.musketeer'),
        (('F~o~o', ' B a r', 'BaZ '), 'foo,b.a.r,baz'),
