...
def test_choices_setter_with_strings():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    job.choices = ('a', 'b', 'c')
    assert job._choices == (('a', 'a'), ('b', 'b'), ('c', 'c'))

@pytest.mark.parametrize('invalid_sequence', (['b'], ['b', 2, 'foo']))
def test_choices_setter_with_invalid_sequence(invalid_sequence):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
...
def test_choices_setter_preserves_focus_if_possible(focused_choice):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('1', 1), ('2', 2), ('3', 3)))
    job.focused = ('2', 2)
...
@pytest.mark.parametrize('focused_choice', (('2', 2), '2', 2))
def test_choices_setter_defaults_focus_to_first_choice(focused_choice):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('1', 1), ('2', 2), ('3', 3)))
    job.focused = ('3', 3)
...
def test_choices_setter_emits_dialog_updated_signal():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('1', 1), ('2', 2), ('3', 3)))
    cb = Mock()
...
def test_focused_getter_before_internal_state_is_defined():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
...
def test_focused_getter_after_internal_state_is_defined(focused_index, exp_focused):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    job._focused_index = focused_index
    assert job.focused == exp_focused

def test_focused_setter_with_None():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    job.focused = '3'
...
def test_focused_setter_with_integer(index, exp_focused_index):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    job.focused = index
...
def test_focused_setter_with_choice_tuple(choice, exp_focused_index):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    job.focused = choice
    assert job._focused_index == exp_focused_index
...
def test_focused_setter_with_choice_item(item, exp_focused_index):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 'x'), ('b', 'y'), ('c', 'z')))
    job.focused = item
    assert job._focused_index == exp_focused_index

def test_focused_setter_with_invalid_choice():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    with pytest.raises(ValueError, match=r"^Invalid choice: 'nope'$"):
        job.focused = 'nope'
    assert job._focused_index == 0

def test_focused_setter_emits_dialog_updated_signal():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    cb = Mock()
    job.signal.register('dialog_updated', cb)
    job.focused = '3'
...
def test_focused_index(focused, exp_focused_index):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=('1', '2', '3'))
    cb = Mock()
    job.signal.register('dialog_updated', cb)
...
def test_choice_getter_without_setting_choice():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
    assert job.choice is None
    job.finish()
    assert job.choice is None

def test_choice_getter_with_setting_choice():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
...
def test_choice_setter_with_item_from_choices(item, exp_choice):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
    assert not job.is_finished
    job.choice = item
...
def test_choice_setter_with_valid_index(index, exp_choice):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
    assert not job.is_finished
    job.choice = index
    assert job.choice == exp_choice
...
def test_choice_setter_with_invalid_index():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
    assert not job.is_finished
...
def test_choice_setter_with_valid_item_from_choice(item, exp_choice):
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 'x'), ('b', 'y'), ('c', 'z')))
    assert not job.is_finished
    job.choice = item
    assert job.choice == exp_choice
...
def test_choice_setter_with_invalid_item_from_choice():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 'x'), ('b', 'y'), ('c', 'z')))
    assert not job.is_finished
...
def test_choice_setter_with_invalid_choice():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 'x'), ('b', 'y'), ('c', 'z')))
    assert not job.is_finished
...
def test_choice_setter_emits_chose_signal():
    job = dialog.ChoiceJob(name='foo', label='Foo', choices=(('a', 1), ('b', 2), ('c', 3)))
    cb = Mock()
